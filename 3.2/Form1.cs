...
//Создать очередь, информационные поля которой содержат числа из текстового файла. 
//Вставить в список за каждым отрицательным числом новый элемент с информационным полем, 
//равным модулю данного отрицательного числа.
namespace _3._2
{
